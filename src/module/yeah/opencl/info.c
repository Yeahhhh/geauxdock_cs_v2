...
print_program_info (cl_program program)
{
  ...
  for (int j = 0; j < sizeof (program_info) / sizeof (Program_info); j++) {
    size_t sz;
...
print_device_info (cl_device_id device)
{
  ...
  for (int j = 0; j < sizeof (device_info_str) / sizeof (Device_info); ++j) {
    size_t sz;
  ...
  for (int j = 0; j < sizeof (device_info_uint) / sizeof (Device_info); ++j) {
    cl_uint info;
...
print_platform_info (cl_platform_id platform)
{
  ...
  for (int j = 0; j < sizeof (platform_info) / sizeof (Platform_info); j++) {
    size_t sz;
