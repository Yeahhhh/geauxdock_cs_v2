...
DMARCRO += -DTARGET_GPU=$(TARGET_GPU) -DTARGET_CPU=$(TARGET_CPU) -DTARGET_MIC=$(TARGET_MIC)
DMARCRO += $(MAKEMACRO)
...
CXXFLAGS_HOST += $(HEADPATH) $(DMARCRO)
CXXFLAGS_HOST += -Wall
ifeq ($(COMPILER), intel)
	CXXFLAGS_HOST += -O3
#	CXXFLAGS_HOST += -fast
...
CXXFLAGS_DEV += $(HEADPATH) $(DMARCRO) $(DMARCRO_GPU)
CXXFLAGS_DEV += -O3
